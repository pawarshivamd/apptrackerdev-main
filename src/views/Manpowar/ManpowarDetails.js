                ...
                {loading ? (
                    ...
                    <Box sx={{ overflowX: 'auto', background: "#ffffff", p: 3, borderRadius: 5, marginInline: 4, my: 2 }}>
                        <Box sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", py: "10px" }}>
                            <Typography variant='h5'>Manpowar Details</Typography>
                            <Box>
                        ...
                        >
                            ...
                            <DialogContent>
                                <DialogContentText id="alert-dialog-description">
                                    Are you sure want to delete Manpowar details?
                                </DialogContentText>
                            </DialogContent>
                            <DialogActions>
                                <Button onClick={handleCloseDialogbox}>No</Button>
                                <Button to="/manpowar" component={Link} autoFocus>
                                    Yes
                                </Button>
                            </DialogActions>
                        </Dialog>
...
export default ManpowarDetails
