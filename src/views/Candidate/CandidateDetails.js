import { Box, Button, Card, Checkbox, Divider, FormControl, FormControlLabel, FormLabel, Grid, MenuItem, Radio, RadioGroup, Tab, Tabs, TextField, Typography } from '@mui/material'
                    ...
                    <FormControl fullWidth className='user-from-section'>
                        <Grid container direction={{ xs: 'column', md: 'row' }} columnSpacing={5} rowSpacing={3}>
                            ...
                            <Grid component="form" item xs={4}>
                                ...
                                <CustomTextField InputLabelProps={{ shrink: true }} type="text" id="cn" value="Stacia" fullWidth />
                            </Grid>
                            <Grid component="form" item xs={4}>
                                <label htmlFor="Nationality" className='text-label'>Nationality</label>
                                <CustomTextField type="text" id="Nationality" value="Singapore" fullWidth />
                            </Grid>
                            <Grid component="form" item xs={4}>
                            ...
                            <Grid component="form" item xs={4} >
                                ...
                                <CustomTextField select id="education" fullWidth value="C.A" >
                                    {status.map((option) => (
                                        <MenuItem key={option.value} value={option.value}>
                                            {option.label}
                                        </MenuItem>
