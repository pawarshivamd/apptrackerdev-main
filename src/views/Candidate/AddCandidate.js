import { Box, Button, Card, Divider, FormControl, FormLabel, Grid, MenuItem, Radio, Tabs, Tab, Typography, } from '@mui/material'
...
const AddCandidate = ({ loading }) => {
    ...
    const [selectedManpower, setSelectedManpower] = useState('OpenXcell'); 
    const [selectedBackOffice, setSelectedBackOffice] = useState('Sattar Patel'); 
    ...
    return (
        <Box component="main" sx={{ flexGrow: 1, my: 10, background: "transparent", height: "100%", }}>
            ...
            <WhitecardBox>
                ...
                <Box sx={{mt:2 , mb:1}}>
                    <Typography>Copany name : Compass Mortgage </Typography>
                </Box>
                <Divider />
                <Box sx={{ mt: 2 }}>
            ...
            <WhitecardBox >
                <Box >
                    <Box sx={{ borderBottom: 1, borderColor: 'divider', }}>
                        <Tabs value={value} onChange={handleChange} aria-label="basic tabs example" TabIndicatorProps={{ sx: { display: 'none' } }} sx={{ '& .MuiTabs-flexContainer': { flexWrap: 'wrap', overflowX: 'auto', }, }}>
                        ...
                        <Box sx={{ mt: 2 }}>
                            <FormControl fullWidth className='user-from-section'>
                                <Grid container direction={{ xs: 'column', md: 'row' }} columnSpacing={5} rowSpacing={3}>
                                    ...
                                    <Grid component="form" item xs={4}>
                                        <label htmlFor="finger-submision-date" className='text-label'>Finger Print & Submission Date</label>
                                        <CustomTextField type="Date" id="finger-submision-date" fullWidth ></CustomTextField>
                                    </Grid>
                                </Grid>
                            </FormControl>
                        </Box>
